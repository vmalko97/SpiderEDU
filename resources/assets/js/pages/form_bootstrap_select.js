...
$(function() {
    ...
    $('.assets-select-solid').selectpicker();
    $('.assets-select-solid').on('show.bs.dropdown', function () {
        $(this).find('.dropdown-menu').addClass('bg-slate');
    });


    // Custom menu color
    $('.assets-select-menu-color').selectpicker();
    $('.assets-select-menu-color').on('show.bs.dropdown', function () {
