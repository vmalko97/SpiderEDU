...
$(function() {
    ...
    $(".steps-validation").validate({
        ...
        errorPlacement: function(error, element) {
            ...
            // Styled checkboxes, radios, assets switch
            if (element.parents('div').hasClass("checker") || element.parents('div').hasClass("choice") || element.parent().hasClass('assets-switch-container') ) {
