<script type="text/javascript">
    ...
    function refresh_messages() {
        ...
        var to = "<?php echo $_SESSION['t_uid'] . '@' . $_SESSION['t_status'];?>";
        $.ajax({
    ...
    $(function () {
        $('#send').click(function () {
            ...
            var to = currentchat;
            var from = "<?php echo $_SESSION['t_uid'] . '@' . $_SESSION['t_status'];?>";
                ...
                <div class="sidebar-category">
                    ...
                    <div class="category-content no-padding">
                        <ul class="media-list media-list-linked">
                            <?php
                            $all_chats = getAllChats($_SESSION['t_uid'] . '@' . $_SESSION['t_status']);
