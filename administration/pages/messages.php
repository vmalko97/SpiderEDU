<script type="text/javascript">
    ...
    $(function () {
        $('#send').click(function () {
            ...
            var to = currentchat;
            var from = "1@super_administrator";
...
<?php
if(isset($_GET['chat'])) {
    $currentchat = filter_input(INPUT_GET, 'chat');
    echo "<script>chat('$currentchat')</script>";
}
?>
<div class="row">
    <div class="col-sm-9">
                ...
                <div class="sidebar-category">
                    ...
                    <div class="category-content no-padding">
                        <ul class="media-list media-list-linked">
                            <?php
                            $all_chats = getAllChats('1@super_administrator');
