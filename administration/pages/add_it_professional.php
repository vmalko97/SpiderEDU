                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data == "ERROR") {
                            swal({
                                title: "Помилка",
                                text: "IT-Професіонала не додано",
                                type: "error",
                            });
                        } else if (data == "OK") {
                            swal({
                                title: "Успіх",
                                text: "IT-Професіонала успішно додано",
                                type: "success",
                            });
                        } else {
                            swal({
...
<div class="panel panel-white">
    <div class="panel-heading">
        <h6 class="panel-title">Додавання IT-Професіонала</h6>
    ...
    <form class="steps-basic" method="post" action="?page=add_teacher">
        ...
        <fieldset>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>ПІБ IT-Професіонала <span class="text text-danger">*</span></label>
                        <input type="text" name="full_name" class="form-control" placeholder="ПІБ IT-Професіонала" required>
