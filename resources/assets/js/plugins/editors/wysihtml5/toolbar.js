!function($, wysi) {
    ...
    var tpl = {
        ...
        "link": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
                "<div class='assets-wysihtml5-insert-link-modal modal fade'>" +
                        ...
                        "<div class='modal-content'>" +
                            ...
                            "<div class='modal-body with-padding'>" +
                                "<div class='form-group'>" +
                                    "<input type='text' value='http://' class='assets-wysihtml5-insert-link-url form-control'>" +
                                    "<div class='checkbox'><label><input type='checkbox' class='assets-wysihtml5-insert-link-target styled' checked>" + locale.link.target + "</label>" + "</div>" +
                                "</div>" +
                            "</div>" +
        ...
        "image": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
                "<div class='assets-wysihtml5-insert-image-modal modal fade'>" +
                    "<div class='modal-dialog'>" +
                        "<div class='modal-content'>" +
                            "<div class='modal-header'>" +
                                "<a class='close' data-dismiss='modal'>&times;</a>" +
                            ...
                            "<div class='modal-body with-padding'>" +
                                "<div class='form-group'>" +
                                    "<input type='text' value='http://' class='assets-wysihtml5-insert-image-url form-control'>" +
                                "</div>" +
                            "</div>" +
                            "<div class='modal-footer'>" +
    ...
    Wysihtml5.prototype = {
        ...
        initInsertImage: function(toolbar) {
            var self = this;
            var insertImageModal = toolbar.find('.assets-wysihtml5-insert-image-modal');
            var urlInput = insertImageModal.find('.assets-wysihtml5-insert-image-url');
        ...
        initInsertLink: function(toolbar) {
            var self = this;
            var insertLinkModal = toolbar.find('.assets-wysihtml5-insert-link-modal');
            var urlInput = insertLinkModal.find('.assets-wysihtml5-insert-link-url');
            var targetInput = insertLinkModal.find('.assets-wysihtml5-insert-link-target');
