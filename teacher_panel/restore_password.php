    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#submit").click(function () {
                var ajax_function = "teacher_restore_password";
...
<body class="login-container" style='background: url("/resources/assets/images/backgrounds/seamless.png");'>
<!-- Main navbar -->
            ...
            <div class="content">
                ...
                <div class="panel panel-body login-form">
                    <div class="text-center">
                        <div class="icon-object border-slate-300 text-slate-300"><i class="icon-book"></i></div>
