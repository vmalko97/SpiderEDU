    ...
    <script type="text/javascript">
        $(function () {
            $("#submit").click(function () {
                var ajax_function = "edit_teacher";
                var id = "<?php echo $id;?>";
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="control-label">ПІБ викладача/IT-професіонала</label>
                            <input type="text" name="full_name" class="form-control"
                                   value="<?php echo $teacher['full_name'] ?>"
                                   placeholder="ПІБ викладача/IT-професіонала"/>
                            ...
                            <label><input type="radio" name="status" value="teacher" <?php if($teacher['status'] == 'teacher'){echo "checked";} ?>/> Викладач</label><br/>
                            <label><input type="radio" name="status" value="it_professional" <?php if($teacher['status'] == 'it_professional'){echo "checked";} ?>/> IT-Професіонал</label>
                            <?php } ?>
                        </div>
